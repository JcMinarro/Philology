...
import com.jcminarro.philology.R.attr
...
class ToolbarViewTransformerTest {
    ...
    fun `Should reword only the title from style`() {
        ...
        val viewResult = ToolbarViewTransformer.reword(toolbar,createAttributeSet(
            StyleAttribute(intArrayOf(attr.title)),
            context = context
        ))
    ...
    fun `Should reword only the subtitle from style`() {
        ...
        val viewResult = ToolbarViewTransformer.reword(toolbar,createAttributeSet(
            StyleAttribute(intArrayOf(attr.subtitle)),
            context = context
        ))
    ...
    fun `Should reword title and subtitle from style`() {
        ...
        val viewResult = ToolbarViewTransformer.reword(toolbar,createAttributeSet(
            StyleAttribute(intArrayOf(attr.title, attr.subtitle)),
            context = context
        ))
